...
const HSelectTrigger = qwik.component$((props) => {
  ...
  const isDisabled = qwik.useComputed$(() => context.isDisabledSig.value || props.disabled ? true : void 0);
