/**
 * @license
 * @qwik.dev/core/cli 2.0.0-beta.13-dev+cb19ff7
...
function rD() {
  ...
  return Object.defineProperty(r, "codes", { value: e2, enumerable: false }), r.color.close = "\x1B[39m", r.bgColor.close = "\x1B[49m", r.color.ansi = N(), r.color.ansi256 = I(), r.color.ansi16m = R(), r.bgColor.ansi = N(w), r.bgColor.ansi256 = I(w), r.bgColor.ansi16m = R(w), Object.defineProperties(r, { rgbToAnsi256: { value: (u3, t, F2) => u3 === t && t === F2 ? u3 < 8 ? 16 : u3 > 248 ? 231 : Math.round((u3 - 8) / 247 * 24) + 232 : 16 + 36 * Math.round(u3 / 255 * 5) + 6 * Math.round(t / 255 * 5) + Math.round(F2 / 255 * 5), enumerable: false }, hexToRgb: { value: (u3) => {
    ...
    let t, F2, s2;
    if (u3 >= 232) t = ((u3 - 232) * 10 + 8) / 255, F2 = t, s2 = t;
    else {
      u3 -= 16;
      const C2 = u3 % 36;
      t = Math.floor(u3 / 36) / 5, F2 = Math.floor(C2 / 6) / 5, s2 = C2 % 6 / 5;
    }
    const i2 = Math.max(t, F2, s2) * 2;
    if (i2 === 0) return 30;
    let D2 = 30 + (Math.round(s2) << 2 | Math.round(F2) << 1 | Math.round(t));
    return i2 === 2 && (D2 += 60), D2;
  }, enumerable: false }, rgbToAnsi: { value: (u3, t, F2) => r.ansi256ToAnsi(r.rgbToAnsi256(u3, t, F2)), enumerable: false }, hexToAnsi: { value: (u3) => r.ansi256ToAnsi(r.hexToAnsi256(u3)), enumerable: false } }), r;
}
function Y(e2, u3, t) {
...
function $2(e2, u3) {
  ...
  for (const t of e2) if (t !== void 0 && $2(t, u3)) return true;
  return false;
}
function BD(e2, u3) {
  if (e2 === u3) return;
...
`), F2 = u3.split(`
`), s2 = [];
  for (let i2 = 0; i2 < Math.max(t.length, F2.length); i2++) t[i2] !== F2[i2] && s2.push(i2);
  return s2;
}
function pD(e2) {
  return e2 === S;
...
function fD({ input: e2 = import_node_process.stdin, output: u3 = import_node_process.stdout, overwrite: t = true, hideCursor: F2 = true } = {}) {
  ...
  "node_modules/.pnpm/@clack+core@0.5.0/node_modules/@clack/core/dist/index.mjs"() {
    ...
    (function(e2) {
      ...
      u3.length = function(F2) {
        for (var s2 = t(F2), i2 = 0, D2 = 0; D2 < s2.length; D2++) i2 = i2 + this.characterLength(s2[D2]);
        return i2;
    ...
    sD = L(FD);
    w = 10;
    N = (e2 = 0) => (u3) => `\x1B[${u3 + e2}m`;
    I = (e2 = 0) => (u3) => `\x1B[${38 + e2};5;${u3}m`;
    R = (e2 = 0) => (u3, t, F2) => `\x1B[${38 + e2};2;${u3};${t};${F2}m`;
    ...
    aD = (e2) => e2.split(" ").map((u3) => p(u3));
    k = (e2, u3, t) => {
      const F2 = [...u3];
      let s2 = false, i2 = false, D2 = p(P(e2[e2.length - 1]));
      for (const [C2, n2] of F2.entries()) {
        const E = p(n2);
        if (D2 + E <= t ? e2[e2.length - 1] += n2 : (e2.push(n2), D2 = 0), d.has(n2) && (s2 = true, i2 = F2.slice(C2 + 1).join("").startsWith(_)), s2) {
    ...
    lD = (e2, u3, t = {}) => {
      ...
      const D2 = aD(e2);
      let C2 = [""];
      for (const [E, a2] of e2.split(" ").entries()) {
        ...
        if (E !== 0 && (o3 >= u3 && (t.wordWrap === false || t.trim === false) && (C2.push(""), o3 = 0), (o3 > 0 || t.trim === false) && (C2[C2.length - 1] += " ", o3++)), t.hard && D2[E] > u3) {
          ...
          Math.floor((D2[E] - 1) / u3) < f && C2.push(""), k(C2, a2, u3);
          continue;
        }
...
`)];
      for (const [E, a2] of n2.entries()) {
        ...
        n2[E + 1] === `
` ? (i2 && (F2 += K("")), s2 && o3 && (F2 += z(o3))) : a2 === `
` && (s2 && o3 && (F2 += z(s2)), i2 && (F2 += K(i2)));
      }
      return F2;
    };
    ...
    vD = (e2, u3, t) => u3 in e2 ? gD(e2, u3, { enumerable: true, configurable: true, writable: true, value: t }) : e2[u3] = t;
    h = (e2, u3, t) => (vD(e2, typeof u3 != "symbol" ? u3 + "" : u3, t), t);
    x = class {
      constructor(u3, t = true) {
        h(this, "input"), h(this, "output"), h(this, "_abortSignal"), h(this, "rl"), h(this, "opts"), h(this, "_render"), h(this, "_track", false), h(this, "_prevFrame", ""), h(this, "_subscribers", /* @__PURE__ */ new Map()), h(this, "_cursor", 0), h(this, "state", "initial"), h(this, "error", ""), h(this, "value");
        const { input: F2 = import_node_process.stdin, output: s2 = import_node_process.stdout, render: i2, signal: D2, ...C2 } = u3;
        this.opts = C2, this.onKeypress = this.onKeypress.bind(this), this.close = this.close.bind(this), this.render = this.render.bind(this), this._render = i2.bind(this), this._track = t, this._abortSignal = D2, this.input = F2, this.output = s2;
      }
      unsubscribe() {
      ...
      emit(u3, ...t) {
        ...
        for (const i2 of F2) i2.cb(...t), i2.once && s2.push(() => F2.splice(F2.indexOf(i2), 1));
      ...
      prompt() {
        return new Promise((u3, t) => {
          ...
          F2._write = (s2, i2, D2) => {
            var _a2, _b2;
            this._track && (this.value = (_a2 = this.rl) == null ? void 0 : _a2.line.replace(/\t/g, ""), this._cursor = ((_b2 = this.rl) == null ? void 0 : _b2.cursor) ?? 0, this.emit("value", this.value)), D2();
      ...
      onKeypress(u3, t) {
        var _a2, _b2;
        if (this.state === "error" && (this.state = "active"), (t == null ? void 0 : t.name) && (!this._track && B.aliases.has(t.name) && this.emit("cursor", B.aliases.get(t.name)), B.actions.has(t.name) && this.emit("cursor", t.name)), u3 && (u3.toLowerCase() === "y" || u3.toLowerCase() === "n") && this.emit("confirm", u3.toLowerCase() === "y"), u3 === "	" && this.opts.placeholder && (this.value || ((_a2 = this.rl) == null ? void 0 : _a2.write(this.opts.placeholder), this.emit("value", this.opts.placeholder))), u3 && this.emit("key", u3.toLowerCase()), (t == null ? void 0 : t.name) === "return") {
          if (this.opts.validate) {
            const F2 = this.opts.validate(this.value);
            F2 && (this.error = F2 instanceof Error ? F2.message : F2, this.state = "error", (_b2 = this.rl) == null ? void 0 : _b2.write(this.value));
          }
          this.state !== "error" && (this.state = "submit");
        }
        $2([u3, t == null ? void 0 : t.name, t == null ? void 0 : t.sequence], "cancel") && (this.state = "cancel"), (this.state === "submit" || this.state === "cancel") && this.emit("finalize"), this.render(), (this.state === "submit" || this.state === "cancel") && this.close();
      }
      close() {
        var _a2;
        this.input.unpipe(), this.input.removeListener("keypress", this.onKeypress), this.output.write(`
`), m(this.input, false), (_a2 = this.rl) == null ? void 0 : _a2.close(), this.rl = void 0, this.emit(`${this.state}`, this.value), this.unsubscribe();
      }
      restoreCursor() {
...
`)), this._prevFrame = u3;
    ...
    PD = (e2, u3, t) => u3 in e2 ? OD(e2, u3, { enumerable: true, configurable: true, writable: true, value: t }) : e2[u3] = t;
    J = (e2, u3, t) => (PD(e2, typeof u3 != "symbol" ? u3 + "" : u3, t), t);
    LD = class extends x {
      constructor(u3) {
    ...
    RD = class extends x {
      get valueWithCursor() {
        ...
        const u3 = this.value.slice(0, this.cursor), [t, ...F2] = this.value.slice(this.cursor);
        return `${u3}${import_picocolors.default.inverse(t)}${F2.join("")}`;
      }
      get cursor() {
        return this._cursor;
      }
...
var init_dist2 = __esm({
  "node_modules/.pnpm/@clack+prompts@0.11.0/node_modules/@clack/prompts/dist/index.mjs"() {
    ...
    G2 = (t) => {
      const { cursor: n2, options: r2, style: i2 } = t, s2 = t.maxItems ?? Number.POSITIVE_INFINITY, c3 = Math.max(process.stdout.rows - 4, 0), a2 = Math.min(c3, Math.max(s2, 5));
      let l2 = 0;
      n2 >= l2 + a2 - 3 ? l2 = Math.max(Math.min(n2 - a2 + 3, r2.length - a2), 0) : n2 < l2 + 2 && (l2 = Math.max(n2 - 2, 0));
      const $4 = a2 < r2.length && l2 > 0, g2 = a2 < r2.length && l2 + a2 < r2.length;
      return r2.slice(l2, l2 + a2).map((p2, v2, f) => {
        const j2 = v2 === 0 && $4, E = v2 === f.length - 1 && g2;
        return j2 || E ? import_picocolors2.default.dim("...") : i2(p2, v2 + l2 === n2);
      });
    };
...
`, r2 = t.placeholder ? import_picocolors2.default.inverse(t.placeholder[0]) + import_picocolors2.default.dim(t.placeholder.slice(1)) : import_picocolors2.default.inverse(import_picocolors2.default.hidden("_")), i2 = this.value ? this.valueWithCursor : r2;
      switch (this.state) {
        case "error":
          return `${n2.trim()}
...
`;
        ...
        case "cancel":
          return `${n2}${import_picocolors2.default.gray(o)}  ${import_picocolors2.default.strikethrough(import_picocolors2.default.dim(this.value ?? ""))}${((_a2 = this.value) == null ? void 0 : _a2.trim()) ? `
...
`;
    ...
    ye = (t) => {
      const n2 = t.active ?? "Yes", r2 = t.inactive ?? "No";
      return new dD({ active: n2, inactive: r2, initialValue: t.initialValue ?? true, render() {
...
${import_picocolors2.default.gray(o)}`;
          default:
            return `${i2}${import_picocolors2.default.cyan(o)}  ${this.value ? `${import_picocolors2.default.green(k2)} ${n2}` : `${import_picocolors2.default.dim(P2)} ${import_picocolors2.default.dim(n2)}`} ${import_picocolors2.default.dim("/")} ${this.value ? `${import_picocolors2.default.dim(P2)} ${import_picocolors2.default.dim(r2)}` : `${import_picocolors2.default.green(k2)} ${r2}`}
${import_picocolors2.default.cyan(d2)}
`;
        }
      } }).prompt();
...
`;
        switch (this.state) {
          case "submit":
            return `${r2}${import_picocolors2.default.gray(o)}  ${n2(this.options[this.cursor], "selected")}`;
          case "cancel":
            return `${r2}${import_picocolors2.default.gray(o)}  ${n2(this.options[this.cursor], "cancelled")}
${import_picocolors2.default.gray(o)}`;
          default:
            return `${r2}${import_picocolors2.default.cyan(o)}  ${G2({ cursor: this.cursor, options: this.options, maxItems: t.maxItems, style: (i2, s2) => n2(i2, s2 ? "active" : "inactive") }).join(`
...
`);
    ...
    M2 = { message: (t = "", { symbol: n2 = import_picocolors2.default.gray(o) } = {}) => {
      const r2 = [`${import_picocolors2.default.gray(o)}`];
      if (t) {
        const [i2, ...s2] = t.split(`
`);
        r2.push(`${n2}  ${i2}`, ...s2.map((c3) => `${import_picocolors2.default.gray(o)}  ${c3}`));
      }
...
`);
    ...
    Y2 = ({ indicator: t = "dots" } = {}) => {
      const n2 = V2 ? ["\u25D2", "\u25D0", "\u25D3", "\u25D1"] : ["\u2022", "o", "O", "0"], r2 = V2 ? 80 : 120, i2 = process.env.CI === "true";
      let s2, c3, a2 = false, l2 = "", $4, g2 = performance.now();
      const p2 = (m2) => {
...
`);
        ...
        const h3 = (performance.now() - m2) / 1e3, w2 = Math.floor(h3 / 60), I2 = Math.floor(h3 % 60);
        return w2 > 0 ? `[${w2}m ${I2}s]` : `[${I2}s]`;
      }, H = (m2 = "") => {
        a2 = true, s2 = fD(), l2 = R2(m2), g2 = performance.now(), process.stdout.write(`${import_picocolors2.default.gray(o)}
`);
        let h3 = 0, w2 = 0;
        j2(), c3 = setInterval(() => {
          if (i2 && l2 === $4) return;
        ...
        const w2 = h3 === 0 ? import_picocolors2.default.green(C) : h3 === 1 ? import_picocolors2.default.red(L2) : import_picocolors2.default.red(W2);
    ...
    for (let i2 = 0; i2 < elms.length; i2++) {
      ...
      if (ts2.isCallExpression(elm) && ts2.isIdentifier(elm.expression)) {
        if (elm.expression.escapedText === "qwikVite") {
          elms[i2] = updateQwikRouterPlugin(ts2, elm, updates.qwikViteConfig);
        }
      }
    }
  }
  ...
  try {
    ...
    if (viteConfig) {
      ...
      if (!import_fs.default.existsSync(viteConfigPath)) {
        viteConfigPath = (0, import_path.join)(rootDir, "vite.config.ts");
      }
      if (!import_fs.default.existsSync(viteConfigPath)) {
...
async function readTemplates(rootDir) {
  ...
  return {
    component: component.map((c3) => parseTemplatePath(c3, "component")),
...
function updateFileContent(path7, content) {
  ...
  M2.info(`"${path7}" has been updated`);
}
...
function getPackageTag() {
  ...
  ).filter((v2) => v2.length === 2).sort((a2, b3) => {
    let aIndex = versionTagPriority.indexOf(a2[0]);
...
function printVersion() {
  console.log("2.0.0-beta.13-dev+cb19ff7");
}
