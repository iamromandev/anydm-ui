...
export declare const extendableAssertions: typeof booleanGuards.assert & typeof boundaryGuards.assert & typeof entryEqualityGuards.assert & typeof enumGuards.assert & typeof httpGuards.assert & typeof instanceGuards.assert & typeof jsonEqualityGuards.assert & typeof keyGuards.assert & typeof lengthGuards.assert & typeof neverGuard.assert & typeof nullishGuards.assert & typeof numericGuards.assert & typeof outputGuards.assert & typeof primitiveGuards.assert & typeof promiseGuards.assert & typeof regexpGuards.assert & typeof runtimeTypeGuards.assert & typeof simpleEqualityGuards.assert & typeof throwGuards.assert & typeof uuidGuards.assert & typeof valueGuards.assert;
/**
